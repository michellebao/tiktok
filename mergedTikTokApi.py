...
# --function {getTrendingTikToks,getTrendingHashtags,getTrendingMusic,getHashtagInfo,getUserInfo,getUserLikedByUsername,getSuggestedUsers,getSuggestedHashtags,getSuggestedMusic,viewTikTokByAddr}
#                       Function name
# --n N                 n count
...
# --crawl CRAWL         Crawl
  FUNCTION_MAP = {
    ...
    'viewTikTokByAddr': viewTikTokByAddr
  }
  ...
  if args.function == 'viewTikTokByAddr':
    if not args.url:
      print('No url given')
      return
    out = func(args.url)
